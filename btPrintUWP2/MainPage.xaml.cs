...
namespace btPrintUWP2
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void fillFilesListbox()
        {
            try
            {
...
//                        btnListPrinters.IsEnabled = true;
        ...
        private async void SendFile(StreamSocket dataSocket)
        {
            try
            {
        ...
        private async void ReceiveStringLoop(DataReader dataReader)
        {
            try
            {
                ...
                if (bufLen > 0)
                {
                    ...
                    NotifyUser("rcvd: " + s, NotifyType.StatusMessage);
//                    ConversationList.Items.Add(s);
        ...
        {
            StreamSocket socket = await DeviceList_Connect();
            //if (dataWriter == null)
            //    return;
            SendFile(socket);
            Disconnect("print done");
        }
    }
}
